    ...
    return (
        ...
        <Container className='my-5 py-5 text-center d-flex justify-content-center form-bg'>
            <form className='d-flex flex-column justify-content-center w-50 form-container' >
                ...
                <p className='text-white'>Don't have an account ? <Link className='text-decoration-none text-white' to="/login">Login</Link></p>
                <button className="btn btn-dark">Register</button>
                ----------------------------or--------------------------------
                <button className="btn btn-info w-50">Register with google</button>
            </form>
        </Container>
        </>
        </div>
